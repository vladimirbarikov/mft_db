...
CREATE TABLE IF NOT EXISTS breakpoint_data (
    ...
    MODEL_CODE model_codes NOT NULL,
    OLD_PART_NUMBER VARCHAR(50),
    NEW_PART_ID VARCHAR(12) NOT NULL,
    OLD_SUPPLIER_NAME VARCHAR(200),
    NEW_SUPPLIER_ID VARCHAR(12) NOT NULL,
    OLD_LINE_CODE VARCHAR(10),
    OLD_LINE_NAME VARCHAR(50),
    NEW_LINE_ID VARCHAR(12) NOT NULL,
    LOCALIZATION localization,
    FOREIGN KEY (MODEL_NAME) REFERENCES model_data (MODEL_ID),
