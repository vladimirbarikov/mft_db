...
CREATE TABLE IF NOT EXISTS breakpoint_history (
    ...
    CURRENT_PART_NUMBER VARCHAR(50) NOT NULL,
    NEW_PART_NUMBER VARCHAR(50) NOT NULL,
    PART_NAME VARCHAR(100) NOT NULL,
    BREAKPOINT_NUMBER VARCHAR(50) NOT NULL,
    BREAKPOINT_DATE TIMESTAMP WITH TIME ZONE,
    CURRENT_LINE_ID VARCHAR(10) NOT NULL,
    NEW_LINE_CODE VARCHAR(10),
    NEW_LINE_NAME VARCHAR(50),
    CURRENT_MODEL_ID VARCHAR(10) NOT NULL,
    CURRENT_SUPPLIER_ID VARCHAR(200),
    NEW_SUPPLIER_NAME VARCHAR(200),
    LOCALIZATION localization
);
